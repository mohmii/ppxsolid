...
namespace cs_ppx
{
    ...
    public class PMPHandler : IPropertyManagerPage2Handler9
    {
        ...
        public void OnClose(int reason)
        {
            ...
            {
                //iSwApp.SendMsgToUser("I got the message");
                
                string[] rpList = new string[2];
                rpList.SetValue(userPage.rList.get_ItemText(userPage.rList.CurrentSelection), 0);
                rpList.SetValue(userPage.pList.get_ItemText(userPage.pList.CurrentSelection), 1);

                userAddin.rpList = rpList;
